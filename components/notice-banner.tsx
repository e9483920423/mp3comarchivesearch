...
export default function NoticeBanner() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-red-500/60 p-4 sm:p-5 mb-5 sm:mb-7 relative rounded-2xl shadow-sm">
      ...
      <p className="text-xs sm:text-sm md:text-base pr-10 sm:pr-12 leading-relaxed font-extrabold text-neutral-800">
        <strong className="text-black font-extrabold">Notice:</strong> This site indexes the Internet Archive's MP3.com Rescue Barge collection. All files are hosted externally by the Internet Archive, with songs belonging to their respective owners. Inspired by{" "}
        <a
